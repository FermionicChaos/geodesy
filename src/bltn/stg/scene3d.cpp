...
namespace geodesy::bltn::stg {
	...
	scene3d::scene3d(std::shared_ptr<core::gcl::context> aContext, std::string aName) : ecs::stage(aContext, aName) {
		...
		this->create_object<ecs::object>("Pigwithanimation", 	SpawnObjects[4], 	math::vec<float, 3>(-40.0f, 30.0f, 0.0f), 	math::vec<float, 2>(0.0f, 0.0f), 	math::vec<float, 3>(5.0f, 5.0f, 5.0f));
		...
		this->create_object<ecs::object>("Cesium Man", 			SpawnObjects[6], 	math::vec<float, 3>(-20.0f, 0.0f, 0.0f), 	math::vec<float, 2>(0.0f, 0.0f), 	math::vec<float, 3>(10.0f, 10.0f, 10.0f));

		this->Object[5]->AnimationWeights = { 0.0f, 1.0f };
		this->Object[6]->AnimationWeights = { 0.0f, 1.0f };
		this->Object[7]->AnimationWeights = { 0.0f, 1.0f };
		this->Object[8]->AnimationWeights = { 0.0f, 1.0f };
	}
