...
namespace geodesy::core::io {
	...
	std::vector<file::registry_item> file::Registry = {
		...
		{ file::extension::SHADER_RGSH,				file::loader::SHADER, 				{ "rgen", "rgsh" }			},
		{ file::extension::SHADER_AHSH,				file::loader::SHADER, 				{ "rahit", "ahsh" }			},
		{ file::extension::SHADER_CHSH,				file::loader::SHADER, 				{ "rchit", "chsh" }			},
		{ file::extension::SHADER_MSSH,				file::loader::SHADER, 				{ "rmiss", "mssh" }			},
		{ file::extension::SHADER_INSH,				file::loader::SHADER, 				{ "rint", "insh" }			},
		{ file::extension::SHADER_CASH,				file::loader::SHADER, 				{ "rcall", "cash" }			},
